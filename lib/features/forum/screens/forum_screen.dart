          ...
          data: (forum) => NestedScrollView(
                  ...
                  return [
                    SliverAppBar(
                      ...
                      flexibleSpace: Stack(
                        children: [
                          Positioned.fill(
                            child: forum!.banner == Constants.forumBannerDefault
                                ? Image.asset(
                                    forum.banner,
                                    fit: BoxFit.cover,
                                  )
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text('${forum.registrants.length} members'),
                                    const SizedBox(
                                      height: 10,
                                    ),
                                            ...
                                            child: OutlinedButton(
                                              ...
                                              style: ElevatedButton.styleFrom(
                                                  ...
                                                  padding: const EdgeInsets
                                                      .symmetric(
                                                      horizontal: 25)),
                                              child: const Text('Forum Tools'),
                                            ),
                                          )
                                        : const SizedBox(),
                                    user.uid == forum.uid || forum.public
                                        ?
                                        // join button
                                        OutlinedButton(
                                            onPressed: () => joinForum(context),
                                            style: ElevatedButton.styleFrom(
                                                shape: RoundedRectangleBorder(
                                                  borderRadius:
                                                      BorderRadius.circular(10),
                ...
                body: Padding(
                  ...
                  child: forum!.recentPostId.isNotEmpty
                      ? ref.watch(getPostByIdProvider(forum.recentPostId)).when(
                            data: (post) {
                              return ref
                                  .watch(getServiceByIdProvider(post.serviceId))
                                  .when(
                                    data: (service) {
                                      return Column(
                                        crossAxisAlignment:
